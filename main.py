...
for i in table:
    table1 = i.find_all(class_="selection-film-item-meta__meta-additional-item")
    country.append(table1[0].text)
for i in table:
    table1 = i.find_all(class_="rating__value rating__value_positive")
    rating.append(table1[0].text)
for i in table:
    table1 = i.find_all(class_="selection-film-item-meta__meta-additional")
    genre.append(table1[0].text)
for i in table:
